...
NeoBundle 'git://github.comthinca/vim-ref'
NeoBundle 'git://github.comtyru/vim-altercmd'
NeoBundle 'git://github.commattn/webapi-vim'
NeoBundle 'git://github.commattn/excitetranslate-vim'
